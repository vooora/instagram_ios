...
//    }
//
//    private func configureTableView() { //collection view
...
//
//        postImageView.frame = CGRect(x: 0, y: usernameLabel.bottom + 20,
//                                     width: contentView.frame.width, height: 300)
//
//        captionLabel.frame = CGRect(x: padding, y: postImageView.bottom + 20,
//                                    width: contentWidth, height: 8)
//
//        likeButton.frame = CGRect(x: padding, y: captionLabel.bottom + 20, width: 30, height: 30)
//
